landing_data = {
    "stats": [
        ...
        {
            "label": "Average Score Improved",
            "value": "34%"
        },
        {
            "label": "Grading Hours Saved",
            "value": "1.2M+"
        },
        {
    ...
    "features": [
        {
            ...
            "description":
                "Dynamically adapt course materials, quizzes, and pacing."
        },
        {
            "icon": "FaChartLine",
    ...
    "services": [
        {
            ...
            "summary":"Provide students with instant, conversational tutoring on complex topics, available any time of day."
        },
        {
            "icon": "FaBolt",
            "name": "Grading & Feedback Copilot",
            "summary": "Automate rubric-based grading for assignments and generate constructive, personalized feedback in seconds."
        },
        {
            "icon": "FaChartLine",
     ...
     "showcases": [
        {
            ...
            "description": "Monitor classroom engagement, assignment completion rates, and curriculum effectiveness in one unified view.",
            "metric": "Save 12hrs/week"
        },
        {
            "icon": "FaRegFileAlt",
            "title": "Dynamic Lesson Builder",
            "description": "Turn a static syllabus into interactive modules, flashcards, and practice exams with a single click.",
    ...
    "previews": [
        ...
        {
            "quote": "Grading 150 essays used to take my entire weekend. Now, the feedback copilot does the heavy lifting, and I just review.",
            "author": "Oliver Grant",
            "role": "Literature Teacher, Nova High School"
        },
        {
            "quote": "Our online bootcamp completion rates skyrocketed after implementing the predictive learning paths. It's a massive competitive advantage.",
            "author": "Sana Idris",
